...
# Type of feature extraction for conditioning vectors (classic or BERT)
parser.add_argument('--conditioning', type=str, default="classic", help="Type of feature extraction for conditioning vectors (classic or BERT) (default: classic)")
...
trainset = preprocess_dataset("train", args.n_max_nodes, args.spectral_emb_dim, args.conditioning)
validset = preprocess_dataset("valid", args.n_max_nodes, args.spectral_emb_dim, args.conditioning)
testset = preprocess_dataset("test", args.n_max_nodes, args.spectral_emb_dim, args.conditioning)
