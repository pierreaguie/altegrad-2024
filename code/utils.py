...
from extract_feats import extract_feats, extract_numbers, extract_BERT



def preprocess_dataset(dataset, n_max_nodes, spectral_emb_dim, conditioning : str = "classic"):
    ...
    if dataset == 'test':
        ...
        if os.path.isfile(filename):
            ...
            for line in fr:
                ...
                elif conditioning == "BERT":
                    feats_stats = extract_BERT(desc)
                else:
                    raise ValueError("Conditioning not recognized")
        ...
        if os.path.isfile(filename):
            ...
            for fileread in tqdm(files):
                ...
                if conditioning == "classic":
                    ...
                    feats_stats = extract_BERT(fstats)
                else:
                    raise ValueError("Conditioning not recognized")
